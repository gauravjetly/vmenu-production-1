...
export const restaurantTemplates: MenuTemplate[] = [
  {
    id: uuidv4(),
    version: '1.0.0',
    metadata: {
...
export function getRestaurantTemplates(): MenuTemplate[] {
  return restaurantTemplates;
}

export function getTemplateById(id: string): MenuTemplate | undefined {
  return restaurantTemplates.find(template => template.id === id);
}